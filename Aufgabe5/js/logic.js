    ...
    var $ = (w[a.k] = {
        ...
        f: {
            ...
            pop: (o) => {
                ...
                // open pop-up window
                $.w.open(query, "pin" + Date.now(), "status=no,resizable=yes,scrollbars=yes,personalbar=no,directories=no,location=no,toolbar=no,menubar=no,height=" +
                    $.a.pop.height +
                    ",width=" +
                    $.a.pop.width +
                    ",left=" +
            ...
            checkImage: (o) => {
                ...
                f = [
                    ...
                    () => {
                        if (!o.img.currentSrc.match(/^http/) &&
                ...
                if ($.w.self === $.w.top) {
                    ...
                    try {
                        if ($.w.top.innerHeight === $.w.self.innerHeight &&
                            ...
                            if ($.w.top.location.href.match(/^https?:\/\/blog\.naver\.com\//) ||
            ...
            openOverlay: (o) => {
                let path, postMessageObj = {}, witnessMe, writeStyles;
                ...
                pongLogin: (o) => {
                    ...
                    if ($.v.hazLogin === true) {
                        ...
                        if ($.v.ctrl.canHaz.pfob) {
                            ...
                            $.f.debug("PFOB is NOT allowed, because canHaz.pfob = " +
                                $.v.ctrl.canHaz.pfob);
                        }
                    }
                    else {
