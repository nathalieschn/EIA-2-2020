...
(function (dancefloor) {
    ...
    function lightCanvas() {
        ...
        let light = new dancefloor.Light((_a =  !== null &&  !== void 0 ?  : ) !== null && _a !== void 0 ? _a : );
        light.draw(dancefloor.crc2);
    }
    // Kleiner Canvas: Confetti
    function confettiCanvas() {
        var _a;
        let _animationobject;
        let confetti = new dancefloor.Confetti((_a =  !== null &&  !== void 0 ?  : ) !== null && _a !== void 0 ? _a : );
        confetti.draw(dancefloor.crc2);
    }
    //Kleiner Canvas: Discoball
    function ballCanvas() {
        var _a;
        let _animationobject;
        let ball = new dancefloor.Ball((_a =  !== null &&  !== void 0 ?  : ) !== null && _a !== void 0 ? _a : );
        ball.draw(dancefloor.crc2);
    }
