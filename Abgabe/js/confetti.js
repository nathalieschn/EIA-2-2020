...
(function (dancefloor) {
    class Confetti extends dancefloor.Animationobject {
        ...
        draw(_crc) {
            dancefloor.crc2.rect(10, 10, 10, 5);
            dancefloor.crc2.rect(40, 15, 10, 5);
            dancefloor.crc2.rect(15, 30, 10, 5);
            dancefloor.crc2.rect(45, 40, 10, 5);
            dancefloor.crc2.rect(5, 50, 10, 5);
